...
namespace AutoRent_Presentation.Views
{
    ...
    /// </summary>
    public sealed partial class TruckAutoInfo : Page
    {
        private DataBase db;
        public ObservableCollection<Truck> slctdTruck { get; set; }
        public TruckAutoInfo()
        {
            this.InitializeComponent();
            slctdTruck = new ObservableCollection<Truck>
            {
                SelectedCarData.SelectedTruck,
            };
        }
