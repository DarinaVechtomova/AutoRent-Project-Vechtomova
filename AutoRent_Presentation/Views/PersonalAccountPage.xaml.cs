...
namespace AutoRent_Presentation.Views
{
    ...
    /// </summary>
    public sealed partial class PersonalAccountPage : Page
    {
        DataBase db;
        ...
        private void ButtonPersonalDate_Click(object sender, RoutedEventArgs e)
        {
            Frame.Navigate(typeof(ChangePersonalData), db);
        }

        private void ButtonOrderStartPage_Click(object sender, RoutedEventArgs e)
        {
            Frame.Navigate(typeof(PersonalAccountPage), db);
        }
